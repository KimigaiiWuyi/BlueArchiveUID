...
async def draw_assist_card(assist: Union[AssistInfo, RankAssistInfo]):
    ...
    if assist:
        ...
        student_pic = Image.open(STUDENT_COLLECTION_PATH / f"{student_id}.webp")
        ...
        for sindex, s in enumerate(skill_data):
            ...
            skill_draw.text((70, 40), f"等级{skill}", skill_color, cf(30), "lm")
        ...
        assist_draw.text((151, 414), f"等级{student_level}", BLACK, cf(25), "mm")
        ...
        if assist["weapon"]:
            ...
            weapon_draw.text((470, 70), f"等级{weapon_level}", BLACK, cf(25), "mm")
...
@gs_cache()
async def draw_user_info_img(_fcode: str, ev: Event, user_id: str) -> Union[str, bytes]:
